...
public class DeleteDiaryDialogue extends DialogFragment {
     ...
     * @return returns a built dialog asking to delete all diary entries.
     */
    @NonNull
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage("Are you sure you want to delete all Diary Entries?")
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        executorService.execute(new Runnable() {
                            @Override
                            public void run() {
                                sleepTrackDB.diaryDAO().deleteAllDiaryEntries();
                            }
                        });
                        Intent refreshIntent = new Intent(DeleteDiaryDialogue.this.getActivity(), MainActivity.class);
                        DeleteDiaryDialogue.this.startActivity(refreshIntent);
                    }
                })
